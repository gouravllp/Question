...
const dataList = [
  {
    title: "Cardiovascular/Hematologic",
    options: [
      "Anemia",
      "Heart Attack",
    ...
    name: "cardiovascularHematologic",
  },
  {
    title: "Respiratory",
    options: ["Asthma", "Bronchitis/Pneumonia", "Emphysema/COPD"],
    name: "respiratory",
  },
  {
    title: "Cardiovascular/Hematologic",
    ...
    name: "cardiovascularHematologic2",
  },
];

export const PastMedicalHistory2 = ({
  setPatientMedicationInfo,
  patientMedicationInfo,
}) => {
  const [pastMedicationInfo, setPastMedicationInfo] = useState({
    medicationAllergies: "",
  });
  ...
  return (
    <div className="flex flex-col justify-between w-full gap-8">
      <div className=" flex flex-col justify-start items-start gap-5 max-w-max p-8 rounded-lg border border-[#0A1E44] shadowsForMainWrapper">
        <h3 className="font-mainFont font-[600] text-[1.6vw] text-white">
          Do you have any drug/medication allergies?
        </h3>
        <div className="flex justify-start items-center gap-4">
          <button
            onClick={() => {
              setPastMedicationInfo({
                ...pastMedicationInfo,
            ...
            className={`text-[#333333]   px-8 py-1 text-[1vw] font-mainFont font-[500] rounded-full  transition-all duration-200 ease-linear shadowsForMainWrapper ${
              pastMedicationInfo.medicationAllergies === "Yes"
          ...
          <button
            ...
            className={`text-[#333333]   px-8 py-1 text-[1vw] font-mainFont font-[500] rounded-full  transition-all duration-200 ease-linear shadowsForMainWrapper ${
              pastMedicationInfo.medicationAllergies === "No"
                ? "text-white btnGraident"
                : "text-black bg-white"
            }`}
          >
